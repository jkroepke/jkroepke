...
- [MuhammedKalkan/OpenLens](https://github.com/MuhammedKalkan/OpenLens) ([v6.4.12](https://github.com/MuhammedKalkan/OpenLens/releases/tag/v6.4.12), 1 day ago) - OpenLens Binary Build Repository
...
- [electron-userland/electron-builder](https://github.com/electron-userland/electron-builder) ([v24.1.2](https://github.com/electron-userland/electron-builder/releases/tag/v24.1.2), 2 days ago) - A complete solution to package and build a ready for distribution Electron app with “auto update” support out of the box
