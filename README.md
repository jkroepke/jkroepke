...
- [kubernetes/dashboard](https://github.com/kubernetes/dashboard) ([web/v1.3.0](https://github.com/kubernetes/dashboard/releases/tag/web/v1.3.0), today) - General-purpose web UI for Kubernetes clusters
