...
#### 🌱 My current projects
- [⭐️ 1789 - jkroepke/helm-secrets](https://github.com/jkroepke/helm-secrets) - I love the deployment via helm. The original helm-secrets project was discontinued. I started a fork and I learn how bash unit tests work!
...
- [prometheus/prometheus](https://github.com/prometheus/prometheus) ([v2.53.5](https://github.com/prometheus/prometheus/releases/tag/v2.53.5), today) - The Prometheus monitoring system and time series database.
