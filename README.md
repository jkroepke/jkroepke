...
- [prometheus-community/helm-charts](https://github.com/prometheus-community/helm-charts) ([prometheus-smartctl-exporter-0.3.1](https://github.com/prometheus-community/helm-charts/releases/tag/prometheus-smartctl-exporter-0.3.1), today) - Prometheus community Helm charts
- [argoproj/argo-helm](https://github.com/argoproj/argo-helm) ([argocd-image-updater-0.8.1](https://github.com/argoproj/argo-helm/releases/tag/argocd-image-updater-0.8.1), today) - ArgoProj Helm Charts
- [aws/karpenter](https://github.com/aws/karpenter) ([v0.18.0](https://github.com/aws/karpenter/releases/tag/v0.18.0), today) - Kubernetes Node Autoscaling: built for flexibility, performance, and simplicity.
