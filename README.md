...
- [kubernetes/dashboard](https://github.com/kubernetes/dashboard) ([web/v1.2.1](https://github.com/kubernetes/dashboard/releases/tag/web/v1.2.1), today) - General-purpose web UI for Kubernetes clusters
