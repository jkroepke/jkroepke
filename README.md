...
- [stakater/Forecastle](https://github.com/stakater/Forecastle) ([v1.0.81](https://github.com/stakater/Forecastle/releases/tag/v1.0.81), 1 day ago) - Forecastle is a control panel which dynamically discovers and provides a launchpad to access applications deployed on Kubernetes  – [✩Star] if you&#39;re using it!
- [argoproj/argo-helm](https://github.com/argoproj/argo-helm) ([argo-workflows-0.16.6](https://github.com/argoproj/argo-helm/releases/tag/argo-workflows-0.16.6), 2 days ago) - ArgoProj Helm Charts
...
- [k8s-at-home/charts](https://github.com/k8s-at-home/charts) ([uptime-kuma-1.3.5](https://github.com/k8s-at-home/charts/releases/tag/uptime-kuma-1.3.5), 3 days ago) - Helm charts for applications you run at home
- [aquasecurity/trivy](https://github.com/aquasecurity/trivy) ([v0.29.2](https://github.com/aquasecurity/trivy/releases/tag/v0.29.2), 4 days ago) - Scanner for vulnerabilities in container images, file systems, and Git repositories, as well as for configuration issues and hard-coded secrets
- [aws/karpenter](https://github.com/aws/karpenter) ([v0.12.0](https://github.com/aws/karpenter/releases/tag/v0.12.0), 5 days ago) - Kubernetes Node Autoscaling: built for flexibility, performance, and simplicity.
...
- [adorsys/keycloak-config-cli](https://github.com/adorsys/keycloak-config-cli) ([v5.2.1](https://github.com/adorsys/keycloak-config-cli/releases/tag/v5.2.1), 6 days ago) - Import YAML/JSON-formatted configuration files into Keycloak - Configuration as Code for Keycloak.
