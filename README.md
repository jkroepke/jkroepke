...
- [kubernetes/dashboard](https://github.com/kubernetes/dashboard) ([api/v1.4.0](https://github.com/kubernetes/dashboard/releases/tag/api/v1.4.0), today) - General-purpose web UI for Kubernetes clusters
