...
- [kubernetes/dashboard](https://github.com/kubernetes/dashboard) ([api/v1.7.0](https://github.com/kubernetes/dashboard/releases/tag/api/v1.7.0), 1 day ago) - General-purpose web UI for Kubernetes clusters
